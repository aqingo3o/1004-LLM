...
# 關於分支還沒同步...
你可能遇到main有更動過文件位置但自己的分支還沒同步的問題，這時候在VS Code介面左邊最下面的圖示，可以新增PR，下面灰色框框有一個`Resolve Conflicts`，按下去並去第三個圖示看看，藍色大框框應該會變成同步之類的東西，按下去就好了
